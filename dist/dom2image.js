...
!(function (a) {
  ...
  function m () {
    ...
    function p (a) {
      ...
      var c = r(a, 'border-right-width')
      return a.scrollWidth + b + c
    }
    function q (a) {
      var b = r(a, 'border-top-width')

      var c = r(a, 'border-bottom-width')
  ...
  function n () {
    ...
    function b (a) {
      for (var b, c = []; (b = e.exec(a)) !== null;) c.push(b[1])
  ...
  var u = { imagePlaceholder: void 0, cacheBust: !1 }
  ...
  typeof module !== 'undefined' ? (module.exports = v) : (a.domtoimage = v)
})(this)
